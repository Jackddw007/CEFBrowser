...
namespace CefiBrowser
{
    public class FATabStripItemCollection : CollectionWithEvents
    {
        ...
        public virtual void SwichItem(FATabStripItem currItem, FATabStripItem DsItem)
        {
            int currItem_Index = List.IndexOf(currItem);
            int DsItem_Index = List.IndexOf(DsItem);

            List[currItem_Index] = DsItem;
            List[DsItem_Index] = currItem;
        }
