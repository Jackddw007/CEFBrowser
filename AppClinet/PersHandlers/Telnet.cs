...
namespace CefiBrowser
{
    ...
    public class ScriptingTelnet
    {
        ...
        private void OnRecievedData(IAsyncResult ar)
        {
            ...
            public bool Connect()
            {
            // IPHostEntry IPHost = System.Net.IPAddress.Parse(address); // Dns.GetHostEntry(address);

            IPAddress IPHost = System.Net.IPAddress.Parse(address);
            ...
            try
                {
                    ...
                    iep = new IPEndPoint(IPHost, port);
                    s.Connect(iep);
