...
//        {
//            myForm = form;
//            tab = myForm.faTabStrip1.SelectedItem;// (browserControl); //这个很重要，解决自动域名纠错
//        }
...
//            {
//                // Set referer
//                request.SetReferrer(tab.URL, ReferrerPolicy.Always);
//            }
...
//            if (response.MimeType.Contains("application/octet-stream") == true)
//            {
