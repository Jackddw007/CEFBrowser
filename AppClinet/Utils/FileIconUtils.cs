...
namespace CefiBrowser
{
	...
	public static class FileIconUtils {
		...
		/// </summary>
		struct SHFILEINFO {
#pragma warning disable CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.hIcon”赋值，字段将一直保持其默认值
			/// <summary>
			/// Handle to the icon that represents the file. You are responsible for
			/// destroying this handle with DestroyIcon when you no longer need it. 
			/// </summary>
			public IntPtr hIcon;
#pragma warning restore CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.hIcon”赋值，字段将一直保持其默认值

#pragma warning disable CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.iIcon”赋值，字段将一直保持其默认值
			/// <summary>
			/// Index of the icon image within the system image list.
			/// </summary>
			public IntPtr iIcon;
#pragma warning restore CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.iIcon”赋值，字段将一直保持其默认值

#pragma warning disable CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.dwAttributes”赋值，字段将一直保持其默认值 0
			/// <summary>
...
#pragma warning restore CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.dwAttributes”赋值，字段将一直保持其默认值 0
...
#pragma warning disable CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.szDisplayName”赋值，字段将一直保持其默认值 null
			public string szDisplayName;
#pragma warning restore CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.szDisplayName”赋值，字段将一直保持其默认值 null

			/// <summary>
			/// String that describes the type of file.
			/// </summary>
			[MarshalAs(UnmanagedType.ByValTStr, SizeConst = 80)]
#pragma warning disable CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.szTypeName”赋值，字段将一直保持其默认值 null
			public string szTypeName;
#pragma warning restore CS0649 // 从未对字段“FileIconUtils.SHFILEINFO.szTypeName”赋值，字段将一直保持其默认值 null
		};
